...
const registrationSchema={type:'object',properties:{title:{type:'string'},summary:{type:'array',minItems:1,maxItems:8,items:{type:'string'}},suggestions:{type:'array',minItems:1,maxItems:8,items:{type:'object',properties:{title:{type:'string'},description:{type:'string'},tags:{type:'array',items:{type:'string'}}},required:['title','description'],additionalProperties:false}},classification:{type:'object',properties:{field:{type:'string',enum:fields},reason:{type:'string'}},required:['field','reason'],additionalProperties:false}},required:['title','summary','suggestions','classification'],additionalProperties:false};
