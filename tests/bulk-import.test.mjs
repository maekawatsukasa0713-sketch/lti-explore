...
try{
 ...
 for(const patch of [{bulkReviewed:false},{field:'未分類'},{storagePath:''},{title:''},{status:'公開中'},{aiAnalysis:{summary:[]},aiReviewedAt:undefined},{aiRequested:true},{aiState:{state:'failed',reason:'invalid_response'}},{aiRequested:true,aiAnalysis:{summary:[]},aiReviewedAt:null}])assert.throws(()=>publicationOps([{id:'1',version:3,data:{...paper,...patch}}],{'1':3}));
 ...
 console.log('PASS: reviewed-only bulk publication, missing and failed AI blocked, stale versions rejected');
