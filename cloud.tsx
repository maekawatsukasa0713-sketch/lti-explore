...
function values(store:Store,key:string):any[] {
 ...
 if(kind==='papers')return items.map(p=>({...p,messages:store.rows.find(r=>r.kind==='paper_threads'&&r.id===String(p.id))?.data.messages||[]}));
